 ...
 * @method \App\Model\Entity\Maintainer|bool saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 ...
 * @method \App\Model\Entity\Maintainer findOrCreate($search, callable $callback = null, $options = [])
 *
